                                    ...
                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                      <div class="img-logo">
                                        <img align="center" border="0"
                                          src="https://sicuan.ethes.tech/uploads/depart/lido1.png" alt="image"
                                          title="image"
                                          style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 18%;max-width: 99.36px;"
                                          width="99.36" class="v-src-max-width">
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-line-height"
                                  ...
                                  <h3>HALO
                                    <?= strtoupper($lamaran['name_candidate']) ?>!
                                  </h3>
                                  <p>
                                    <strong>Selamat kamu dinyatakan</strong>
                                  </p>
                                  <br>
                                  <span style="color: #0096FF; font-size: 30px;"><b>LOLOS</b></span>
                                  <br><br>
                                  <p>Dari seluruh tes yang telah kamu lalui pada lowongan yang kamu lamar,
                                    yaitu sebagai
                                    <strong><?= strtoupper($lamaran['name_job']) ?></strong>
                                    dengan kode lowongan
                                    <strong><?= $lamaran['kode_lowongan'] ?></strong>.
                                  </p>

                                  <br>
                                  <p>Untuk informasi lebih lanjut, buka situs kami pada <a
                                      href="https://www.ethestm.co.id">www.ethestm.co.id</a>&nbsp; atau langsung
                                    menghubungi admin di 0811291979</p>
                                  <br>
                                  <br>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-line-height"
                                  ...
                                  <span style="color: #0096FF; font-size: 30px;"><b>LOLOS</b></span>
                                  <br><br>
                                  <p>Dari tahap <strong><?= $result[0]['name_timeline']['name_timeline'] ?></strong> dalam proses pendaftaran lowongan <strong><?= strtoupper($lamaran['name_job']) ?></strong> selanjutnya anda akan mengikuti tahap selanjutnya,
                                    yaitu <strong> <?= $current_timeline['name_timeline']['name_timeline'] ?> </strong>
                                  </p>
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-line-height"
                                  ...
                                  <p>
                                    <strong>Terima kasih telah mendaftar pada lowongan kami. Kami telah menerima aplikasi Anda dan telah meninjaunya dengan cermat. Namun, sayangnya, lamaran anda untuk posisi <?= strtoupper($lamaran['name_job']) ?> dinyatakan</strong>
                                  </p><br>
                                  <span style="color: #0096FF; font-size: 30px;"><b>TIDAK LOLOS</b></span>
                                  <br><br>
                                  <p>
                                    Kami berharap Anda akan tetap bersemangat dan berjuang untuk mendapatkan kesempatan kerja yang sesuai dengan keinginan dan kompetensi Anda. Kami berharap Anda dapat diterima di lowongan lain yang Anda lamar atau pada lowongan kami di masa yang akan datang.
                                  </p>
                        ...
                        <div
                          ...
                          <table id="u_content_text_3" style="font-family:arial,helvetica,sans-serif;"
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding"
                                  style="overflow-wrap:break-word;word-break:break-word;padding:60px 50px 10px;font-family:arial,helvetica,sans-serif;"
                                  align="left">
                                  <div class="v-line-height"
                                    style="line-height: 170%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 170%;">If you have any questions, please
                                      email us at rnd@ethes.tech or whatsapp number 08112939780, you can also chat with
                                      a reel live human during our operating hours. They can answer questions about Gate
                                      Aplication</p>
                                  </div>
                                </td>
                              </tr>
                            ...
                            <tbody>
                              <tr>
                                <td class="v-container-padding-padding"
                                  ...
                                  <div class="v-line-height"
                                    style="line-height: 170%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 170%;">Head Office Lido Grosir Krajan, Kec.
                                      Kandangan, Kabupaten Temanggung, Jawa Tengah 56281</p>
                                    <p style="font-size: 14px; line-height: 170%;">Presented By RND Ethes Tech</p>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
