                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <h1 class="v-line-height v-font-size"
                                  style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: `Montserrat`,sans-serif; font-size: 24px;">
                              ...
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-line-height"
                                  ...
                                  <p style="font-size: 14px; line-height: 170%;">
                                    Silahkan verifikasi akun anda agar dapat mengakses akun.
                                    <br>
                                    Setelah verifikasi akun masukkan username & password pada saat login
                                    <br>
                                    <br>
                                    <br>
                                    <a href="<?= $link ?>"
                                      class="standard-btn-coloured"
                                      style="text-decoration: none; background: #00acec; border: 2px solid #00ACEC; padding:10px 20px 10px 20px; border-radius: 2px; color: #FFFFFF; margin: 5px;">Verify</a>
                                    <br>
                                    <br>
                                    <br>
                                </div>
