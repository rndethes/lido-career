window.addEventListener("DOMContentLoaded", function () {
  ...
  if (this.document.getElementById("button-form-edit-lp-hero")) {
    this.document
      .getElementById("button-form-edit-lp-hero")
      .addEventListener("click", function (e) {
    ...
    if (elem) {
      if (elem.style.display != "block") {
        ...
        if (target == "pengalaman-kerja") {
          makeAFormReadOnly(
            document.getElementById("form-edit-kandidat-pengalaman-kerja"),
            true
          );
          disableAButton(
            document.getElementById(
              "form-edit-kandidat-pengalaman-kerja-button-save"
            ),
            true
          );
        }
  ...
  const formDataDiri = this.document.getElementById(
    "form-edit-kandidat-data-diri"
  );
  const formDataDiriButton = this.document.getElementById(
    "form-edit-kandidat-data-diri-button-save"
  );
    ...
    formDataDiriButton.addEventListener("click", function () {
      ...
      jxhr.onload = function () {
        if (jxhr.status >= 200 && jxhr.status < 400) {
          Swal.fire(
            "Updated!",
            "Data diri kandidat berhasil diupdate.",
            "success"
          ).then((x) => {
            ...
            Object.keys(response.data).map(function (kv) {
              ...
              if (kv == "birthdate_candidate") {
                findAndFill(
                  "birthdate_candidate",
                  response.data["birthdate_candidate_"]
                );
              } else if (kv == "tempat_lahir_candidate") {
                findAndFill(
                  "tempat_lahir_candidate",
                  response.data["tempat_lahir_candidate_"]
                );
              } else {
                if (
                  !kv.includes("tempat_lahir_candidate") ||
                  !kv.includes("tempat_lahir_candidate")
                ) {
          ...
          Swal.fire(
            "Failed!",
            "Data diri kandidat gagal diupdate.",
            "error"
          ).then(() => {
            makeAFormReadOnly(formDataDiri, false);
            disableAButton(formDataDiriButton, false);
  ...
  const formDataPendidikan = this.document.getElementById(
    "form-edit-kandidat-pendidikan"
  );
  const formDataPendidikanButton = this.document.getElementById(
    "form-edit-kandidat-pendidikan-button-save"
  );
    ...
    formDataPendidikanButton.addEventListener("click", function () {
      ...
      jxhr.onload = function () {
        if (jxhr.status >= 200 && jxhr.status < 400) {
          Swal.fire(
            "Updated!",
            "Data pendidikan kandidat berhasil diupdate.",
            "success"
          ).then((x) => {
            var response = JSON.parse(jxhr.responseText);
          ...
          Swal.fire(
            "Failed!",
            "Data pendidikan kandidat gagal diupdate.",
            "error"
          ).then(() => {
            makeAFormReadOnly(formDataPendidikan, false);
            disableAButton(formDataPendidikanButton, false);
  ...
  const formDataAlamat = this.document.getElementById(
    "form-edit-kandidat-alamat"
  );
  const formDataAlamatButton = this.document.getElementById(
    "form-edit-kandidat-alamat-button-save"
  );
    ...
    formDataAlamatButton.addEventListener("click", function () {
      ...
      jxhr.onload = function () {
        if (jxhr.status >= 200 && jxhr.status < 400) {
          Swal.fire(
            "Updated!",
            "Data alamat kandidat berhasil diupdate.",
            "success"
          ).then((x) => {
            var response = JSON.parse(jxhr.responseText);
          ...
          Swal.fire(
            "Failed!",
            "Data alamat kandidat gagal diupdate.",
            "error"
          ).then(() => {
            makeAFormReadOnly(formDataAlamat, false);
            disableAButton(formDataAlamatButton, false);
  ...
  const formDataPengalaman = this.document.getElementById(
    "form-edit-kandidat-pengalaman-kerja"
  );
  const formDataPengalamanButton = this.document.getElementById(
    "form-edit-kandidat-pengalaman-kerja-button-save"
  );
  const formDataPengalamanButtonCancel = this.document.getElementById(
    "form-edit-kandidat-pengalaman-kerja-button-cancel"
  );

  this.document
    .querySelectorAll(".form-edit-kandidat-pengalaman-kerja-trigger-edit")
    .forEach((elem) => {
      elem.addEventListener("click", function () {
    ...
    formDataPengalamanButton.addEventListener("click", function () {
      ...
      jxhr.onload = function () {
        if (jxhr.status >= 200 && jxhr.status < 400) {
          Swal.fire(
            "Updated!",
            "Data pengalaman kerja kandidat berhasil diupdate.",
            "success"
          ).then((x) => {
            var response = JSON.parse(jxhr.responseText);
            ...
            try {
              response.pengalaman.forEach((row) => {
                document
                  .querySelectorAll(
                    ".form-edit-kandidat-pengalaman-kerja-trigger-edit"
                  )
                  .forEach((elem) => {
                    if (elem.dataset.id_ce == row.id_ce) {
                      ...
                      document.getElementById(
                        "td_name_company_" + row.id_ce
                      ).innerText = row.name_company;
                      document.getElementById(
                        "td_type_company_" + row.id_ce
                      ).innerText = row.type_company;
                      document.getElementById(
                        "td_employee_company_" + row.id_ce
                      ).innerText = row.employee_company;
                      document.getElementById(
                        "td_year_fmt__" + row.id_ce
                      ).innerText = diffDateForHuman(
                        new Date(row.first_year),
                        new Date(row.last_year)
                      );
                      document.getElementById(
                        "td_description_" + row.id_ce
                      ).dataset.content = row.description;
          ...
          Swal.fire(
            "Failed!",
            "Data pengalaman kerja kandidat gagal diupdate.",
            "error"
          ).then(() => {
            makeAFormReadOnly(formDataPengalaman, false);
            disableAButton(formDataPengalamanButton, false);
  ...
  const showDescriptionPengalamanModal = this.document.getElementById(
    "showDescriptionModal"
  );

  this.document
    .querySelectorAll(
      ".form-edit-kandidat-pengalaman-kerja-trigger-description"
    )
    .forEach((elem) => {
      elem.addEventListener("click", function (e) {
        var modal = bootstrap.Modal.getOrCreateInstance(
          showDescriptionPengalamanModal
        );
  ...
  if (showDescriptionPengalamanModal) {
    showDescriptionPengalamanModal.addEventListener(
      "show.bs.modal",
      function (e) {
  ...
  this.document
    .querySelectorAll(".form-edit-kandidat-pengalaman-kerja-trigger-delete")
    .forEach((elem) => {
      elem.addEventListener("click", function () {
          ...
          if (willDelete.isConfirmed) {
            ...
            request.onload = function () {
              if (request.status >= 200 && request.status < 400) {
                ...
                Swal.fire(
                  "Failed!",
                  "Data pengalaman kerja gagal dihapus.",
                  "error"
                );
              }
            };
  ...
  const formDataPendukungTambahan = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan"
  );
  const formDataPendukungTambahanButton = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-button-upload"
  );
  const formDataPendukungTambahanFieldFile = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-field-file"
  );
  const formDataPendukungTambahanThumbnail = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-thumbnail"
  );
  const formDataPendukungTambahanFileName = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-file-name"
  );
  const formDataPendukungTambahanInfo = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-info"
  );
  const formDataPendukungTambahanButtonDelete = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-button-delete"
  );
  const formDataPendukungTambahanButtonDowload = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-button-download"
  );
  const formDataPendukungTambahanButtonPreview = this.document.getElementById(
    "form-edit-kandidat-file-pendukung-tambahan-button-preview"
  );

  if (
    formDataPendukungTambahanButtonDelete &&
    formDataPendukungTambahanFileName &&
    formDataPendukungTambahanThumbnail
  ) {
    if (
      formDataPendukungTambahanFileName.innerText.includes("default.pdf") ||
      formDataPendukungTambahanThumbnail.innerText.trim() == ""
    ) {
  ...
  if (formDataPendukungTambahanButtonDelete) {
    formDataPendukungTambahanButtonDelete.addEventListener(
      "click",
      function () {
        Swal.fire({
          title: "Are you sure?",
    ...
    formDataPendukungTambahanButton.addEventListener("click", function () {
      ...
      if (!file) {
        ...
        if (!file.type.toLowerCase().includes("pdf")) {
          ...
          request.onload = function () {
            if (request.status >= 200 && request.status < 400) {
              Swal.fire("Updated!", "File berhasil di upload.", "success").then(
                (x) => {
                  ...
                  formDataPendukungTambahanFileName.innerText =
                    response.data.file_name;
                  formDataPendukungTambahanThumbnail.style.display = "block";
                  formDataPendukungTambahanButtonDelete.style.display = "block";
                  formDataPendukungTambahanButtonDowload.style.display =
                    "block";
                  formDataPendukungTambahanButtonPreview.style.display =
                    "block";

                  formDataPendukungTambahanButtonPreview.href =
                    response.data.file_url;
                  formDataPendukungTambahanButtonDowload.href =
                    response.data.file_url;
                }
              );
            } else {
              Swal.fire("Failed!", "File gagal di upload.", "error").then(
                () => {
                  ...
                  if (err.has_pendukung) {
                    if (
                      formDataPendukungTambahanButtonDelete.style.display !=
                      "block"
                    ) {
                      formDataPendukungTambahanButtonDelete.style.display =
                        "block";
  ...
  const formDataProfileKandidat = this.document.getElementById(
    "form-edit-kandidat-profile"
  );
  const formDataProfileKandidatFile = this.document.getElementById(
    "form-edit-kandidat-profile-file-input"
  );
  const formDataProfileKandidatImage = this.document.getElementById(
    "form-edit-kandidat-profile-image"
  );
  const formDataProfileKandidatImageWrapper = this.document.getElementById(
    "form-edit-kandidat-profile-image-wrapper"
  );
  const formDataProfileKandidatButton = this.document.getElementById(
    "form-edit-kandidat-profile-button-change"
  );
        ...
        request.onload = function () {
          if (request.status >= 200 && request.status < 400) {
            Swal.fire(
              ...
              if (
                !formDataProfileKandidatButton.classList.contains("btn-danger")
              ) {
                formDataProfileKandidatButton.classList.add("btn-danger");
              }

              if (
                formDataProfileKandidatButton.classList.contains("btn-primary")
              ) {
  ...
  const changeImageModalFileInput = this.document.getElementById(
    "form-change-image-file-input"
  );
  const changeImageModalImagePreview = this.document.getElementById(
    "form-change-image-img-preview"
  );
  const changeImageModalButtonUpdate = this.document.getElementById(
    "form-change-image-button-update"
  );
  const changeImageModalInfoText = this.document.getElementById(
    "form-change-image-info-text"
  );
  const changeImageModalForm =
    this.document.getElementById("form-change-image");
  ...
  if (changeImageModal) {
    ...
    changeImageModal.addEventListener("show.bs.modal", function (e) {
      ...
      changeImageModalDomImgTarget = document.getElementById(
        changeImageModalDomImgTarget
      );
    });
        ...
        if (!file.type.toLowerCase().includes("image")) {
          ...
          if (changeImageModalDestination) {
            ...
            var form = new FormData(
              document.getElementById("form-change-image")
            );
            ...
            request.open("POST", SITE_URL + "pengaturanlandingpage", true);
            request.onload = function () {
              if (request.status >= 200 && request.status < 400) {
                Swal.fire(
                  "Updated!",
                  ...
                  let modal =
                    bootstrap.Modal.getOrCreateInstance(changeImageModal);
                  modal.toggle();
                });
              } else {
                Swal.fire(
                  "Failed!",
                  "Gambar gagal di perbarui..",
                  "error"
                ).then(() => {
                  makeAFormReadOnly(changeImageModalForm, false);
                  disableAButton(changeImageModalButtonUpdate, false);
...
function updateWebsiteSetting(mode) {
  if (mode == "setting") {
    ...
    form.append(
      "field_about_visi",
      CKEDITOR.instances.field_about_visi.getData()
    );
    form.append(
      "field_about_misi",
      CKEDITOR.instances.field_about_misi.getData()
    );
      ...
      if (request.status >= 200 && request.status < 400) {
        Swal.fire(
          ...
          document.getElementById("field_company_title").value =
            response.data.company_title;
          document.getElementById("field_company_title").value =
            response.data.user_announcement;
          document.getElementById("field_about_visi").value =
            response.data.visi || "";
          document.getElementById("field_about_misi").value =
            response.data.misi || "";
...
if (this.document.getElementById("button-form-footer")) {
  this.document
    .getElementById("button-form-footer")
  ...
  if (mode == "setting_footer") {
    ...
    request.onload = function () {
      if (request.status >= 200 && request.status < 400) {
        Swal.fire(
          "Updated!",
          "Pengaturan footer berhasil diupdate.",
          "success"
        ).then((x) => {
          var response = JSON.parse(request.responseText);
          ...
          document.getElementById("field_footer_title").value =
            response.data.tittle_footer;
          document.getElementById("field_footer_konten").value =
            response.data.content_footer;
          document.getElementById("field_footer_address").value =
            response.data.address_footer;
          document.getElementById("field_footer_no").value =
            response.data.no_footer;
          document.getElementById("field_footer_email").value =
            response.data.email_footer;
          document.getElementById("field_footer_map").value =
            response.data.link_map;
...
function updateAboutSetting(
  ...
  request.send(
    `mode=setting_about&id=${id}&title=${title}&subtitle=${subtitle}&description=${description}`
  );
  request.onload = function () {
    if (request.status >= 200 && request.status < 400) {
      Swal.fire(
...
function updateHero(
  ...
  request.onload = function () {
    if (request.status >= 200 && request.status < 400) {
      Swal.fire(
        "Updated!",
        "Pengaturan heropage berhasil diupdate.",
        "success"
      ).then((x) => {
        var response = JSON.parse(request.responseText);
