...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2025 at 01:09 PM
...
CREATE TABLE `candidate` (
  ...
  `photo_candidate` varchar(255) NOT NULL,
...
INSERT INTO `candidate` (`id`, `id_candidate`, `name_candidate`, `email_candidate`, `no_candidate`, `birthdate_candidate`, `jk_candidate`, `address_candidate`, `poskode_candidate`, `address2_candidate`, `poskode2_candidate`, `noaddress_candidate`, `noaddress2_candidate`, `marital_candidate`, `socialmedia2_candidate`, `socialmedia_candidate`, `religion_candidate`, `photo_candidate`, `is_active`, `state`, `date_created`, `password_candidate`, `device_token`) VALUES
(3, 'TR202510002', 'NINDYA RIZQY', 'nindy@gmail.com', '+6281337116001', 'wonosobo, 2000-02-18', '1', 'KENANGAN, SINUNUKAN, KABUPATEN MANDAILING NATAL, SUMATERA UTARA', '12345', 'KENANGAN, SINUNUKAN, KABUPATEN MANDAILING NATAL, SUMATERA UTARA', '12345', '098887990554', '098887990554', '2', 'nindya', 'nindya', '3', 'file_1762730227_8.png', 1, 0, '2025-10-24 20:27:29', '$2y$10$yZOtXuYuR2XPgpD23qn7dOge3zwmxRqfilNMXPVJMSiJzSgrwdjzC', ''),
...
(3, 'SMA, MIPA', 'SMA 1 Wonosobo', '', '2025-10-01', '2025-11-01', 3, 0),
...
(1, 'LIDO', 'LIDO29', 'logo_lidowhite.png', '', 0, '');
...
INSERT INTO `setting_about` (`id`, `about_image`, `about_subtitle`, `about_description`, `about_title`, `about_description2`, `about_image2`, `created_at`, `updated_at`) VALUES
(1, '1762734703_about1_1762687475_about1_b11.jpeg', 'LIDO29', 'Lido29 adalah platform yang berfokus pada retail untuk menghadirkan pengalaman terbaik bagi pelanggan dan mitra. Kami berkomitmen pada kualitas, inovasi, dan kepuasan pelanggan, dengan tujuan memberikan solusi yang relevan, efektif, dan berdampak positif.\r\n\r\nDi Lido29, setiap layanan dan produk dikembangkan dengan mengedepankan kreativitas, profesionalisme, dan inovasi, sehingga dapat memenuhi harapan pelanggan sekaligus mendorong pertumbuhan berkelanjutan.\r\nLido29 adalah platform yang berfokus pada retail untuk menghadirkan pengalaman terbaik bagi pelanggan dan mitra. Kami berkomitmen pada kualitas, inovasi, dan kepuasan pelanggan, dengan tujuan memberikan solusi yang relevan, efektif, dan berdampak positif.', 'Tentang Lido29', 'Lido29 adalah platform inovatif yang berfokus pada pejualan untuk menghadirkan layanan dan produk berkualitas tinggi bagi pelanggan dan mitra. Sejak didirikan, Lido29 berkomitmen untuk menjadi pionir dalam menghadirkan pengalaman terbaik, mengedepankan inovasi, profesionalisme, dan kepuasan pelanggan sebagai prioritas utama.\r\n\r\nKami percaya bahwa setiap layanan dan produk harus memberikan nilai tambah nyata. Oleh karena itu, Lido29 selalu menggabungkan kreativitas, teknologi terkini, dan pendekatan yang berorientasi pada solusi untuk memastikan bahwa setiap solusi yang diberikan relevan, efektif, dan berdampak positif bagi pelanggan maupun komunitas sekitar.\r\n\r\nTim Lido29 terdiri dari para profesional yang berdedikasi, kreatif, dan berpengalaman di bidangnya masing-masing. Dengan kolaborasi yang solid, kami mampu menghadirkan inovasi yang tidak hanya memenuhi kebutuhan saat ini, tetapi juga siap menghadapi tantangan masa depan.\r\n\r\nKami juga menjunjung tinggi tanggung jawab sosial dan keberlanjutan, dengan memastikan bahwa setiap langkah operasional dan pengembangan produk membawa dampak positif bagi masyarakat dan lingkungan. Melalui semangat inovasi dan dedikasi, Lido29 berkomitmen menjadi mitra terpercaya yang selalu menghadirkan kualitas, solusi, dan pengalaman terbaik bagi seluruh pelanggan dan mitra kami.', '1762734704_about2_1762687475_about2_cta-bg.jpg', '2025-11-09 20:08:50', '2025-11-10 07:58:29');

-- --------------------------------------------------------

--
-- Table structure for table `setting_culture`
--

CREATE TABLE `setting_culture` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `about_culture` text NOT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `setting_culture`
--

INSERT INTO `setting_culture` (`id`, `title`, `image`, `about_culture`, `created_at`, `updated_at`) VALUES
(1, 'tes', 'tes', 'tes', '2025-11-09 20:22:19', '2025-11-09 20:22:19');

-- --------------------------------------------------------

--
-- Table structure for table `setting_culture_detail`
--

CREATE TABLE `setting_culture_detail` (
  `id` int(11) NOT NULL,
...
(1, 'Welcome to Lido 29 Platform', 'Connect, Grow and Build Your Future', '1762775599_bg1.jpeg');
...
(1, 'Lido Career Center', 'Lido Grosir', 'img_16759274212444837.png', '#3e5d65', 'Menjadi platform terdepan yang menghadirkan solusi inovatif, berkualitas, dan berdampak positif bagi pelanggan, mitra, dan masyarakat secara berkelanjutan.', '1. Memberikan layanan dan produk berkualitas tinggi yang memenuhi kebutuhan pelanggan.\r\n2. Mengedepankan inovasi dan kreativitas dalam setiap pengembangan produk dan layanan.\r\n3. Menjunjung tinggi profesionalisme dan kepuasan pelanggan sebagai prioritas utama.\r\n4. Mendorong pertumbuhan berkelanjutan dengan tanggung jawab sosial dan lingkungan.\r\n5. Membangun kolaborasi yang kuat dengan mitra untuk menciptakan solusi efektif dan relevan.', 'Lido Grosir', 'Kami menyediakan berbagai jenis produk FMCG melalui 13 toko cabang kami demi kepuasan pelanggan.', 'Kec Kadangan, Kabupaten Magelang, Jawa Tengah', '0920192019201', 'info@info', 'asadad,sad;l,a', 'https://maps.google.com/maps?width=588&amp;height=281&amp;hl=en&amp;q=ethes tech&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed');
...
--
-- Table structure for table `setting_news`
--

CREATE TABLE `setting_news` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `setting_office`
--

CREATE TABLE `setting_office` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `setting_office`
--

INSERT INTO `setting_office` (`id`, `area`, `type`, `branch_name`, `address`, `maps_url`, `phone_number`, `email`, `image`, `created_at`, `updated_at`) VALUES
(1, 'Wonosobo', 'store', 'Lido29 Wonosobo', 'Kertek, Wonosobo', 'tes', '098876554332', 'lido29wsb@gmail.com', '1762774196_1762687475_about1_b11.jpeg', '2025-11-09 20:14:51', '2025-11-10 07:29:56'),
(2, 'Temanggung', 'Warehouse', 'Lido29 Temanggung', 'idaaa\r\nkleyang gunung', 'tes', '08997665443', 'lido29tmg@gmail.com', '1762776259_Screenshot_(153).png', '2025-11-10 08:04:19', '2025-11-10 08:04:19'),
(3, 'Magelang', 'Warehouse', 'Lido29 Magelang', 'wesrdclfv;bl', 'tes', '08997665443', 'lido29tmg@gmail.com', NULL, '2025-11-10 08:05:07', '2025-11-10 08:05:07'),
(4, 'Semarang', 'Warehouse', 'Lido29 Semarang', '', 'tes', '08997665443', 'lido29tmg@gmail.com', NULL, '2025-11-10 08:05:48', '2025-11-10 08:05:48');

-- --------------------------------------------------------

--
-- Table structure for table `setting_quotes`
--

CREATE TABLE `setting_quotes` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `content` text NOT NULL,
  `image` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `setting_quotes`
--

INSERT INTO `setting_quotes` (`id`, `title`, `content`, `image`, `created_at`, `updated_at`) VALUES
(1, 'Quotes', 'Kesuksesan bukanlah hasil dari keberuntungan semata, tetapi dari ketekunan, disiplin, dan keberanian untuk terus mencoba meskipun gagal. Setiap langkah kecil yang kamu ambil hari ini adalah pondasi untuk impian besar di masa depan. Jangan takut untuk memulai, karena perjalanan seribu mil dimulai dari satu langkah.', '1762735584_quote_cta-bg.jpg', '2025-11-09 20:14:04', '2025-11-10 08:02:34');
...
--
-- Table structure for table `setting_unit_business`
--

CREATE TABLE `setting_unit_business` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `setting_unit_business`
--

INSERT INTO `setting_unit_business` (`id`, `title`, `description`, `link`, `created_at`, `updated_at`) VALUES
(1, 'tes', 'tes', 'tes', '2025-11-09 20:13:30', '2025-11-09 20:13:30'),
(2, 'tes', 'tes', 'tes', '2025-11-09 20:13:30', '2025-11-09 20:13:30');

-- --------------------------------------------------------

--
-- Table structure for table `setting_visimisi_intro`
--

CREATE TABLE `setting_visimisi_intro` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `setting_visimisi_intro`
--

INSERT INTO `setting_visimisi_intro` (`id`, `intro_title`, `intro_description`, `intro_video_url`, `created_at`, `updated_at`) VALUES
(1, 'Bagaimana kinerja kami dalam mewujudkan visi dan misi?', 'Di Lido29, kami percaya bahwa setiap langkah yang kami ambil harus memberikan nilai positif bagi pelanggan, mitra, dan komunitas. Visi dan misi kami menjadi panduan utama dalam menghadirkan solusi yang inovatif, berkualitas, dan berdampak nyata. Dengan fokus pada kreativitas, profesionalisme, dan keberlanjutan, Lido29 berkomitmen untuk terus berkembang dan memberikan kontribusi terbaik di bidangnya.', 'https://youtu.be/im99Picx79Q?si=YwDKlbO1mOXpYxtU', '2025-11-09 20:11:12', '2025-11-10 07:26:19');
...
--
-- Indexes for table `setting_culture`
--
ALTER TABLE `setting_culture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `setting_culture_detail`
--
ALTER TABLE `setting_culture_detail`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `setting_news`
--
ALTER TABLE `setting_news`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `setting_office`
--
ALTER TABLE `setting_office`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `setting_quotes`
--
ALTER TABLE `setting_quotes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `setting_unit_business`
--
ALTER TABLE `setting_unit_business`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `setting_visimisi_intro`
--
ALTER TABLE `setting_visimisi_intro`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `setting_culture`
--
ALTER TABLE `setting_culture`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `setting_culture_detail`
--
ALTER TABLE `setting_culture_detail`
...
--
-- AUTO_INCREMENT for table `setting_news`
--
ALTER TABLE `setting_news`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `setting_office`
--
ALTER TABLE `setting_office`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `setting_quotes`
--
ALTER TABLE `setting_quotes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `setting_unit_business`
--
ALTER TABLE `setting_unit_business`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `setting_visimisi_intro`
--
ALTER TABLE `setting_visimisi_intro`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `setting_culture_detail`
--
ALTER TABLE `setting_culture_detail`
  ADD CONSTRAINT `setting_culture_detail_ibfk_1` FOREIGN KEY (`culture_id`) REFERENCES `setting_culture` (`id`) ON DELETE CASCADE;
COMMIT;
